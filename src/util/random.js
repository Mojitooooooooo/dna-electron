  ...
  */
var BaseRandom, BuiltinRandom, HighQualityRandom, LOG2E, NotImplementedError, POW_32, POW_NEG_32, Random, acos, bind, cos, exp, floor, lg, log, mod, pow, sqrt,
  indexOf = [].indexOf,
...
export var Random = class Random extends BaseRandom {
